...
class SpeechToTextV1 extends BaseService {
   ...
   * @returns {NodeJS.ReadableStream|void}
   */
  recognizeSessionless(params?: SpeechToTextV1.RecognizeSessionlessParams, callback?: SpeechToTextV1.Callback<SpeechToTextV1.SpeechRecognitionResults>): NodeJS.ReadableStream | void {
    const _params = (typeof params === 'function' && !callback) ? {} : extend({}, params);
    const _callback = (typeof params === 'function' && !callback) ? params : (callback) ? callback : () => {};
